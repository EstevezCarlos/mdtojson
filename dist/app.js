...
/**
 * Makes data relational
 * @param {object} obj object to which apply relations
...
const mttj = {
    ...
    // Function takes markdown string and returns every table as JSON.
    ...
    // Function takes markdown file and returns every table as JSON.
    // if there is no tables and silent == false, throws error
    // else if there is only one table, and unpack == true, returns processed table
    // else, return JSON containg multiple objects
